...
## Warum Q (für Arbeitssoziologie und Wearables)?

Q Methodologie wird in vielen Feldern eingesetzt, unter anderem Pflege- und Gesundheitswissenschaften [@akthar-danesh-2008; @Exel-Baker-etal-2015; @baker2006q], Marketing [@Andrews-Drennan-etal-2046; @Mandolesi-Nicholas-etal-2015], Public Policy [@Baker-Jeffares-2013], Psychotherapie [@Bambery-Porcerelli-2007], Persönlichkeitsforschung [@Block-1961],  Politikwissenschaft [@brown-1977] und Beteiligungsprozessen [@Donner-2001; @Doody-Kearney-etal-2009; @Niemeyer2013].

Mittels Q Methode können subjektive Sichtweisen induktiv und operant (also als "pures Verhalten") erfasst, systematisch zusammengefasst, und als idealtypische, geteilte Perspektiven holistisch interpretiert werden. 
Ein solcher Ansatz zur operanten Subjektivität ist besonders hilfreich zur Untersuchung eines relativ jungen Phänomem wie Wearables, zudem Erfahrungen, Annahmen und Werte gerade erst entstehen, und daher explorativ untersucht werden.
Q Methode eignet sich ebenfalls gut um *Differenzen* innerhalb eines Diskurses quantitativ zu erheben, wenn sich unter einem Schlagwort recht unterschiedliche Ausprägungen und Lebenswirklichkeiten versammeln [vgl. @ascher1987subjectivity].

Q Methode ist auch besonders empfohlen um *vermachtete Situationen und Diskurse* zu untersuchen, und Teilnemende zu emanzipieren [@Brown-2006].
Billard zeigt etwa, wie eine feministische Lesart der Q Methode in der *Unternehmensmitbestimmung* (engl. "industrial relations") demokratische Teilhabe stärken kann [@Billard-1999].
